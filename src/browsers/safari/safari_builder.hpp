...
class SafariBuilder final : public BaseBrowserBuilder {
 public:
  explicit SafariBuilder(safari::Version version);

  ~SafariBuilder() override = default;
